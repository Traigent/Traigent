...
def opal_optimize(
    ...
    **override_kwargs: Any,
    ...
    Args:
        ...
        **override_kwargs: Any keyword supported by `traigent.optimize(...)`.
            Values are forwarded unchanged after OPAL compilation so OPAL users
            retain full access to algorithm/trials, injection/execution bundles,
            budget knobs, and runtime controls.

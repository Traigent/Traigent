# Publishing Checklist (LinkedIn + Medium)
...
- Pick one visual (prefer the existing demos):
...
- Reply to the first 5 comments with a question to drive discussion.
- Track 2 signals: (1) saves/shares, (2) inbound DMs (“how do I apply this?”).
- Capture objections you see repeatedly; feed them into Week 4–6 posts (gates, stats, ops, privacy).

## Repurposing loop (fast)

- Medium article → 3 LinkedIn posts:
  1. Contrarian thesis (hook + 1 insight)
  2. Diagram/snippet (one concrete mechanism)
  3. Checklist/poll (engagement + learning)

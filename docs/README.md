...
`traigent first-prompt --agent claude|cursor|codex|copilot`, or `traigent mcp serve`.
...
- **[Smart Optimization](user-guide/smart_optimization.md)** - Backend-routed smart optimizer strategies

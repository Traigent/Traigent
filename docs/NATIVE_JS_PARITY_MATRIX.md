...
| Explicit-object framework discovery | Yes | `matched` | `matched` | [`tests/unit/integrations/auto-wrap.test.ts`](../tests/unit/integrations/auto-wrap.test.ts), [`examples/core/seamless-autowrap/run.mjs`](../examples/core/seamless-autowrap/run.mjs) | `discoverFrameworkTargets(...)` inspects explicitly passed arrays and plain-object graphs, and `prepareFrameworkTargets(...)` supports bounded one-call discover + wrap + status. |

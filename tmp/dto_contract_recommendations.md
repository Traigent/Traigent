...
**File**: `REDACTED_TRAIGENT_ROOT/TraigentSchema/traigent_schema/schemas/evaluation/measures_types.json`
...
**File**: `REDACTED_TRAIGENT_ROOT/TraigentBackend/src/models/measures_dtos.py` (NEW)
...
**File**: `REDACTED_TRAIGENT_ROOT/TraigentFrontend/src/types/measures.ts` (NEW)

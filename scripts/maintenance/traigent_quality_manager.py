    ...
    def list_backups(self) -> List[Dict]:
        ...
        for backup_dir in self.backup_dir.glob("quality_fix_*"):
            ...
            if manifest_file.exists():
                with safe_open(manifest_file, backup_dir, mode="r", encoding="utf-8") as f:
                    manifest = json.load(f)
...
"""
        ...
        safe_write_text(report_file, report_content, self.base_path)
    ...
    def fix_model_typos(self, files_with_issues: List[str]) -> List[Tuple[str, str]]:
        ...
        for file_path_str in files_with_issues:
            ...
            try:
                content = safe_read_text(file_path, self.base_path)
                ...
                if content != original_content:
                    ...
                    if not self.dry_run:
                        safe_write_text(file_path, content, self.base_path)

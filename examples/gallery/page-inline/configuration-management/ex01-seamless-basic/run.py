#!/usr/bin/env python3
"""Run optimization for the seamless-basic example and write results.json.

This file serves as a template for other examples. Duplicate it and change:
- MODULE_NAME
- EXAMPLE_ID
- DATASET filename (if different)
"""
...
MODULE_NAME: str = "seamless_basic"
EXAMPLE_ID: str = "configuration-management__seamless-basic"


# Paths
THIS_DIR: str = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, THIS_DIR)
DATASET: str = os.path.join(THIS_DIR, "summaries.jsonl")
...
def main() -> None:
    ...
    opt_result = asyncio.run(ex.optimized_summary.optimize(max_trials=10))

...
async def main():
    ...
    loaded_from = "files" if KNOWLEDGE_BASE_DOCUMENTS and "file_path" in KNOWLEDGE_BASE_DOCUMENTS[0] else "fallback"
    print(f"Knowledge Base: {len(KNOWLEDGE_BASE_DOCUMENTS)} documents, {total_chars:,} total characters (loaded from {loaded_from})")

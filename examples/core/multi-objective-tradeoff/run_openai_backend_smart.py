#!/usr/bin/env python3
"""Math expression evaluation optimized with backend smart search (accuracy focus).
...
# which has been removed and now hard-fails.
...
async def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Run the backend smart optimization demo"
    )
    parser.add_argument(
        "--verbose-results",
        action="store_true",
    ...
    print("Crunching math expressions with backend smart optimization...")

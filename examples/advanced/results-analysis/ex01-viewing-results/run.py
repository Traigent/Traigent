#!/usr/bin/env python3
"""Runner for Results & Analysis - Viewing Results (Sentiment)."""
...
def main() -> None:
    print("Running Results & Analysis - Viewing Results (Sentiment)")
    print("=" * 60)

    opt_result = asyncio.run(sentiment_classifier.optimize(max_trials=10))

    out: dict[str, Any] = {
        "example": "results-analysis__viewing-results",

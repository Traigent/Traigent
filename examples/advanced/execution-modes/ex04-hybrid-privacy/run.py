#!/usr/bin/env python3
"""Runner for Execution Modes - Hybrid Mode with Privacy."""
...
from hybrid_privacy import proprietary_assistant  # noqa: E402

RESULTS_FILE = "results.json"
DATASET_FILE = "proprietary_dataset.jsonl"
...
def main() -> None:
    print("Running Execution Modes - Hybrid Privacy")
    print("=" * 60)

    opt_result = asyncio.run(proprietary_assistant.optimize(max_trials=10))

    out: dict[str, Any] = {
        "example": "execution-modes__hybrid-privacy",

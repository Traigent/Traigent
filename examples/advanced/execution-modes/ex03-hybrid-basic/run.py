#!/usr/bin/env python3
"""Runner for Execution Modes - Hybrid Mode (Basic)."""
...
from hybrid_basic import complex_llm_pipeline  # noqa: E402

RESULTS_FILE = "results.json"
DATASET_FILE = "evaluation_set.jsonl"
...
def main() -> None:
    print("Running Execution Modes - Hybrid (Basic)")
    print("=" * 60)

    opt_result = asyncio.run(complex_llm_pipeline.optimize(max_trials=10))

    out: dict[str, Any] = {
        "example": "execution-modes__hybrid-basic",

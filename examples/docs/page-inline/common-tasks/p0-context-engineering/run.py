#!/usr/bin/env python3
"""Runner - P0-2 Context Engineering."""
...
def main() -> None:
    print("Running P0-2 Context Engineering (mock mode)")
    print("=" * 60)

    opt_result = asyncio.run(answer_with_context.optimize(max_trials=10))

    out: dict[str, Any] = {
        "example": "common-tasks__p0-context-engineering",

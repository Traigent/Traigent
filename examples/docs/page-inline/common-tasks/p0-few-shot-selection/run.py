#!/usr/bin/env python3
"""Runner - P0-3 Few-Shot Selection."""
...
def main() -> None:
    print("Running P0-3 Few-Shot Selection (mock mode)")
    print("=" * 60)

    opt_result = asyncio.run(classify_sentiment.optimize(max_trials=10))

    out: dict[str, Any] = {
        "example": "common-tasks__p0-few-shot-selection",

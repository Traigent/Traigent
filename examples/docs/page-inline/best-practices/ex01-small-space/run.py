#!/usr/bin/env python3
"""Runner - Best Practices: Small Search Space (Classification)."""
...
DATASET_FILE = "classification.jsonl"
...
def main() -> None:
    print("Running Best Practices - Small Search Space")
    print("=" * 60)

    opt_result = asyncio.run(classify_text.optimize(max_trials=10))

    out: dict[str, Any] = {
        "example": "best-practices__small-space",

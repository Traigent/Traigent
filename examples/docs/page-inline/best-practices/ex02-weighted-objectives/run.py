#!/usr/bin/env python3
"""Runner - Best Practices: Weighted Objectives (MCQ)."""
...
def main() -> None:
    print("Running Best Practices - Weighted Objectives")
    print("=" * 60)

    opt_result = asyncio.run(select_answer.optimize(max_trials=10))

    out: dict[str, Any] = {
        "example": "best-practices__weighted-objectives",

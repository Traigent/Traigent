#!/usr/bin/env python3
"""Run optimization for the parameter-mixed example and write results.json."""
...
# Configuration
MODULE_NAME: str = "parameter_mixed"
EXAMPLE_ID: str = "configuration-management__parameter-mixed"


# Paths
THIS_DIR: str = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, THIS_DIR)
DATASET: str = os.path.join(THIS_DIR, "content_generation.jsonl")
...
def main() -> None:
    ...
    opt_result = asyncio.run(ex.content_generator.optimize(max_trials=10))

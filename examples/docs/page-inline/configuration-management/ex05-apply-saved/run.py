#!/usr/bin/env python3
"""Runner for apply saved configuration example (MCQ)."""
...
from apply_saved import customer_support_agent

RESULTS_FILE = "results.json"
DATASET_FILE = "customer_queries.jsonl"
...
def main() -> None:
    ...
    opt_result = asyncio.run(customer_support_agent.optimize(max_trials=10))

    out: dict[str, Any] = {
        "example": "configuration-management__apply-saved",

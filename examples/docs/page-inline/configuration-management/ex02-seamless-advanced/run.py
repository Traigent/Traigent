#!/usr/bin/env python3
"""Run optimization for the seamless-advanced example and write results.json.

Template: duplicate and update MODULE_NAME, EXAMPLE_ID, and DATASET as needed.
"""
...
# Configuration (adjust per example)
MODULE_NAME: str = "seamless_advanced"
EXAMPLE_ID: str = "configuration-management__seamless-advanced"


# Paths
THIS_DIR: str = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, THIS_DIR)
DATASET: str = os.path.join(THIS_DIR, "content_requirements.jsonl")
...
def main() -> None:
    ...
    except ImportError as exc:  # Show dependency/import problems clearly
    ...
    opt_result = asyncio.run(ex.intelligent_content_system.optimize(max_trials=10))

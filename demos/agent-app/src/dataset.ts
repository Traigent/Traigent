...
export const SENTIMENT_DATASET: DatasetExample[] = [
  ...
  {
    input: { text: 'Terrible experience, very disappointed with the quality.' },
    output: 'negative',
  },
  ...
  {
    input: { text: "I'm somewhat satisfied but expected better battery life." },
    output: 'neutral',
  },
  {
    input: { text: 'Great value! Works exactly as described and arrived early.' },
    output: 'positive',
  },
  { input: { text: 'Frustrating setup process but eventually worked fine.' }, output: 'neutral' },
  {
    input: { text: 'This is the worst product I have ever purchased in my entire life.' },
    output: 'negative',
  },
  ...
  {
    input: { text: 'Decent for beginners, but professionals might want something better.' },
    output: 'neutral',
  },
];
